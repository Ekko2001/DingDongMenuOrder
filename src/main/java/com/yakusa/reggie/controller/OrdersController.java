...
import com.yakusa.reggie.dto.OrdersDto;
...
import com.yakusa.reggie.service.OrdersService;
...
@PutMapping
   ...
   //先接受订单参数,接着查询订单,再修改订单状态,然后根据id更新保存
    //update orders set status = ? where id = ?
    LambdaQueryWrapper<Orders> lambdaQueryWrapper = new LambdaQueryWrapper<>();
    lambdaQueryWrapper.eq(Orders::getId, id);
    Orders orders1 = ordersService.getOne(lambdaQueryWrapper);
